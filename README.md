...
| [controller/](controller/)                                 | The replacement master — a Rust service driving the two Saturn valve buses from a Raspberry Pi, with its design docs, [build order](controller/docs/BUILD-ORDER.md), and parts list in [controller/docs/](controller/docs/). |
