...
| [controller/](controller/)                                 | The replacement master — a Rust service driving two Saturn valve buses and one DTV+ steam link from a Raspberry Pi, with its design docs, [build order](controller/docs/BUILD-ORDER.md), and parts list in [controller/docs/](controller/docs/). |
...
| [INVESTIGATIONS.md](INVESTIGATIONS.md)                     | What we are still trying to find out, and the experiments queued to find it out.                                                                                                                                                                 |
| [docs/](docs/)                                             | Kohler controller reference — hardware, firmware update pipeline, CGI surface, security posture, what firmware extraction would take.                                                                                                            |
