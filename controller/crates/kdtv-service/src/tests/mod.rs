...
async fn the_boot_sequence_probes_every_address_and_confirms_off_before_ready() {
...
#[tokio::test(start_paused = true)]
async fn the_event_stream_carries_the_frames_and_the_stamps_the_log_requires() {
    let harness = Harness::start();
