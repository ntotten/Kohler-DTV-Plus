...
//! and [`req_saturn_protocol_safe_03_req_design_deny_01_no_denied_control_byte_is_reachable`] scans every frame this encoder
...
//!
//! [`req_saturn_protocol_safe_03_req_design_deny_01_no_denied_control_byte_is_reachable`]: self#tests
...
impl SaturnOp {
    ...
    /// [`req_design_deny_02_the_allowlist_is_exactly_these_twenty_operations`].
    ///
    /// [`req_design_deny_02_the_allowlist_is_exactly_these_twenty_operations`]: self#tests
...
mod tests {
    ...
    #[test]
    fn req_design_deny_02_the_allowlist_is_exactly_these_twenty_operations() {
        let expected = [
            SaturnOpKind::AllOff,
            SaturnOpKind::SetOutlets,
            SaturnOpKind::SetTemperature,
    ...
    #[test]
    fn req_saturn_protocol_safe_03_req_design_deny_01_no_denied_control_byte_is_reachable() {
    ...
    #[test]
    fn req_design_deny_03_req_design_deny_04_req_design_deny_05_req_design_deny_06_the_reachable_control_bytes_are_a_known_five()
     {
    ...
    #[test]
    fn req_design_deny_09_address_management_requires_a_token_and_the_discovery_phase() {
        let e = zone1();
        for phase in [
            LinkPhase::Booting,
            LinkPhase::ReadyOff,
    ...
    #[test]
    fn req_hardware_proto_09_a_token_is_not_transferable_between_links() {
        let e = zone1();
    ...
    #[test]
    fn req_design_clamp_05_an_unconfigured_slot_is_refused() {
        let e = zone1();
        let err = e
            .encode(
                addr(0x03),
    ...
    #[test]
    fn req_design_clamp_04_only_clamped_setpoints_can_be_encoded() {
        let e = zone1();
